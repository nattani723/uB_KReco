...
{
  void CCKaonAnalyzerRebuild::ClearEventWeightBranches(){
  ...
  void CCKaonAnalyzerRebuild::CreateEventWeightBranches(){
    std::cout<<"CCKaonAnalyzerRebuild:analyze_Eventweigh:eventweight_tree make branches start"<<std::endl;
    //-----------------run info
    ...
    std::cout<<"CCKaonAnalyzerRebuild:analyze_Eventweigh:eventweight_tree make branches end"<<std::endl;
  }

  void CCKaonAnalyzerRebuild::AnalyzeEventWeight(art::Event const & e){
    std::cout<<"CCKaonAnalyzerRebuild::AnalyzeEventWeight- starting"<<std::endl;
  ...
  std::cout<<"CCKaonAnalyzerRebuild::AnalyzeEventWeight-eventweight_tree filled"<<std::endl;
  }
}
