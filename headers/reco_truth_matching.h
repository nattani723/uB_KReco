...
namespace Kaon_Analyzer
{
  ...
  std::vector<double> Kaon_Analyzer::CCKaonAnalyzerRebuild::showerRecoMCmatching(std::vector<art::Ptr<recob::Shower>>& objectVector,
        ...
        for(size_t i=0; i<objectVector.size();++i){
            ...
            */
            ...
            for(size_t i_h=0; i_h < obj_hits_ptrs.size(); ++i_h){
                ...
                particle_vec.clear(); match_vec.clear(); //only store per hi
