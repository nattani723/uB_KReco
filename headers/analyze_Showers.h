...
{
  void Kaon_Analyzer::CCKaonAnalyzerRebuild::ClearShowers(){
    ...
    void CCKaonAnalyzerRebuild::ResizeShowers(size_t size){
    ...
    void CCKaonAnalyzerRebuild::CreateShowerBranches(){
 ...
 //           std::cout<<"SHOWER3D_ENERGY: best plane: "<<shr3d_bestplane<<std::endl;
   ...
   //         std::cout<<std::endl<<"SHOWER3D_DEDX: "<<std::endl;
    ...
    //-----------------------------------------------------------------------------------------------------------------------------------------
    void CCKaonAnalyzerRebuild::RecoMCShowers(const std::vector<art::Ptr<recob::Shower>>& showers,  
    ...
    void CCKaonAnalyzerRebuild::CollectCalo(const art::Event &evt, const art::Ptr<recob::Shower> &shower)
    {

    }

    double CCKaonAnalyzerRebuild::CalcEShowerPlane(const std::vector<art::Ptr<recob::Hit>>& hits, int this_plane){    
        double energy = 0.;
    ...
    double CCKaonAnalyzerRebuild::CalcEShower(const std::vector<art::Ptr<recob::Hit>> &hits){    
    ...
    double CCKaonAnalyzerRebuild::GetQHit(art::Ptr<recob::Hit> thishitptr, int plane){
        double gain;
	...
	*/
    ...
    double CCKaonAnalyzerRebuild::QtoEConversionHit(art::Ptr<recob::Hit> thishitptr, int plane){
        return QtoEConversion(GetQHit(thishitptr, plane));
    }

    double CCKaonAnalyzerRebuild::QtoEConversion(double Q){
    ...
    std::vector<double> CCKaonAnalyzerRebuild::CalcdEdxFromdQdx(std::vector<double> dqdx){
        int n = dqdx.size();
    ...
    std::vector<double> CCKaonAnalyzerRebuild::CalcdQdxShower(
    ...
    double CCKaonAnalyzerRebuild::getPitch(TVector3 shower_dir, int plane){
    ...
    TVector3 CCKaonAnalyzerRebuild::getWireVec(int plane){
        TVector3 wire_dir;
        if (plane == 0){
    ...
    double CCKaonAnalyzerRebuild::getCoswrtWires(TVector3 shower_dir, TVector3 wire_dir){
    ...
    double CCKaonAnalyzerRebuild::getAnglewrtWires(TVector3 shower_dir,int plane){
    ...
    double CCKaonAnalyzerRebuild::getAmalgamateddEdx(double angle_wrt_plane0, double angle_wrt_plane1, double angle_wrt_plane2, double median_plane0, double median_plane1, double median_plane2, int plane0_nhits, int plane1_nhits, int plane2_nhits){
    ...
    int CCKaonAnalyzerRebuild::getAmalgamateddEdxNHits(double amalgamateddEdx, double median_plane0, double median_plane1, double median_plane2, int plane0_nhits, int plane1_nhits, int plane2_nhits){
    ...
    double CCKaonAnalyzerRebuild::degToRad(double deg){
        return deg * M_PI/180;
    }

    double CCKaonAnalyzerRebuild::radToDeg(double rad){
        return rad * 180/M_PI;
    }

    int CCKaonAnalyzerRebuild::getNHitsPlane(std::vector<art::Ptr<recob::Hit>> hits, int this_plane){
        int nhits = 0;
    ...
    std::vector<std::vector<double>> CCKaonAnalyzerRebuild::buildRectangle(std::vector<double> cluster_start, std::vector<double> cluster_axis, double width, double length){
    ...
    bool CCKaonAnalyzerRebuild::insideBox(std::vector<double> thishit_pos, std::vector<std::vector<double >> rectangle){
    ...
    bool CCKaonAnalyzerRebuild::isInsidev2(std::vector<double> thishit_pos, std::vector<std::vector<double >> rectangle){
        int n_vertices = (int)rectangle.size();
        //bool inside = false;
        int i, j = 0;
        double areas = 0;
    ...
    double CCKaonAnalyzerRebuild::areaTriangle(double x1, double y1, double x2, double y2, double x3, double y3){
        double num = x1*(y2 - y3) + x2*(y3 - y1) + x3*(y1 - y2);
        return abs(num)/2;
    }

    double CCKaonAnalyzerRebuild::getMedian(std::vector<double> thisvector){
