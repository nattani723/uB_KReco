...
namespace Kaon_Analyzer
{
  void Kaon_Analyzer::CCKaonAnalyzerRebuild::ClearMCTruths(){
    ...
    void CCKaonAnalyzerRebuild::ResizeMCTruths(size_t size){
    ...
    void CCKaonAnalyzerRebuild::CreateMCTruthBranches(){
    ...
    void CCKaonAnalyzerRebuild::AnalyzeMCTruths(std::vector<art::Ptr<simb::MCTruth>> & mcTruthVector , std::vector<art::Ptr<simb::MCParticle>> & mcParticleVector){
