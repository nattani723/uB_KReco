...
{
  void Kaon_Analyzer::CCKaonAnalyzerRebuild::ClearTracks(){
    ...
    void CCKaonAnalyzerRebuild::ResizeTracks(size_t size){
    ...
    void CCKaonAnalyzerRebuild::CreateTrackBranches(){
    ...
    void CCKaonAnalyzerRebuild::AnalyzeTracks(const std::vector<art::Ptr<recob::Track>>& tracks,
    ...
    void CCKaonAnalyzerRebuild::RecoMCTracks(const std::vector<art::Ptr<recob::Track>>& tracks,  
        ...
        void CCKaonAnalyzerRebuild::AnalyzeTrackCalo(const std::vector<art::Ptr<recob::Track>> &tracks, std::map<art::Ptr<recob::Track>,std::vector<art::Ptr<anab::Calorimetry>> > &trackToCaloMap)
        {
        ...
        void CCKaonAnalyzerRebuild::CollectPID( std::vector<art::Ptr<recob::Track>> & tracks,
