...
namespace Kaon_Analyzer
{
  ...
  */
  ...
  const double distance_to_line = 1.;
  ...
  void Kaon_Analyzer::CCKaonAnalyzer::fillAngularDistributionMapCheat(std::vector<art::Ptr<recob::Hit>>& hits_from_pfparticle,
  ...
  void Kaon_Analyzer::CCKaonAnalyzer::fillAngularDistributionMapCheat3D(std::vector<art::Ptr<recob::Hit>>& hits_from_pfparticle,
  ...
  void CCKaonAnalyzer::fillAngularDistributionMap( std::vector<art::Ptr<recob::Hit>>& hits_from_pfparticle, 
						   TVector3 Kend_candidate,
						   art::FindManyP<recob::SpacePoint>& spacepoint_per_hit,
  ...
  void CCKaonAnalyzer::fillAngularDistributionMap3D( std::vector<art::Ptr<recob::Hit>>& hits_from_pfparticle, 
						     TVector3 Kend_candidate,
						     art::FindManyP<recob::SpacePoint>& spacepoint_per_hit,
  ...
  void CCKaonAnalyzer::smoothAngularDistributionMapCheat3D(std::map<int, std::map<int, std::map<int, double>>> &angular_distribution_mrgid_map_3D){
  ...
  void CCKaonAnalyzer::smoothAngularDistributionMap3D(std::map<int, std::map<int, double>> &angular_distribution_map_3D){
  ...
  void CCKaonAnalyzer::smoothAngularDistributionMap(std::map<int, double> &angular_distribution_map){
  ...
  void CCKaonAnalyzer::obtainPeakVectorCheat3D(std::map<int, std::map<int, std::map<int, double>>> &angular_distribution_mrgid_map_3D,
					       std::map<int,int>& mrgidpdg,
  ...
  void CCKaonAnalyzer::accumulateAngularDistributionMap3D(std::map<int, std::map<int, double>> &angular_distribution_map_3D_1,
  ...
  void CCKaonAnalyzer::obtainPeakVector3D(std::map<int, std::map<int, double>> &angular_distribution_map_3D,
  ...
  void CCKaonAnalyzer::findBestAngularPeak3D(std::map<int, std::map<int, double>> &angular_distribution_map_3D,
	...
	if(open_angle > TMath::Pi()*0.5) best_peak_bins.push_back(theta_phi_bin);
      ...
      if(best_peak_bins.size() >= 2) break; //just look second highest peak with large opening angle
  ...
  */
  ...
  void CCKaonAnalyzer::findBestAngularPeakCheat3D( std::map<int, std::map<double, TVector2, std::greater<>>>& view_peak_map_cheat,
  ...
  void CCKaonAnalyzer::findShowerSpine3D(std::vector<art::Ptr<recob::Hit>>& hits_from_pfparticle,
	...
	if(excess_hits_in_fit>0){
	  ...
	  //lar_content::LArConnectionPathwayHelper::SortByDistanceToPoint * smpl = new lar_content::LArConnectionPathwayHelper::SortByDistanceToPoint(pandora_extrapolated_end_position);
	  lar_content::LArConnectionPathwayHelper::SortByDistanceToPoint smpl(pandora_extrapolated_end_position);
	  cout << "we want to sort" << endl;
	  std::sort(pandora_running_fit_position_vec.begin(), pandora_running_fit_position_vec.end(), smpl);
	  //std::sort(running_fit_position_vec.begin(), running_fit_position_vec.end(), lar_content::LArConnectionPathwayHelper::SortByDistanceToPoint(pandora_extrapolated_end_position));

	  cout << "before for loop of excess hits" << endl;
	  for (int i = 0; i < excess_hits_in_fit; ++i){
	    cout << "inside loop of excess hits" << endl;
	...
	cout << "before ThreeDSlidingFitResult" << endl;
	...
	cout << "after ThreeDSlidingFitResult" << endl;
	...
	cout << "ifelse is_end_downstream" << endl;


	//extrapolated_start_position = count == 1 ? extrapolated_end_position : is_end_downstream ? extrapolated_fit.GetGlobalMaxLayerPosition() : extrapolated_fit.GetGlobalMinLayerPosition();
	//extrapolated_direction = is_end_downstream ? extrapolated_fit.GetGlobalMaxLayerDirection() : extrapolated_fit.GetGlobalMinLayerDirection() * (-1.f);
  ...
  bool CCKaonAnalyzer::collectSubsectionHits(const lar_content::ThreeDSlidingFitResult &extrapolated_fit,
  ...
  void CCKaonAnalyzer::collectConnectedHits(std::vector<art::Ptr<recob::Hit>>& collected_hits,
					    art::FindManyP<recob::SpacePoint>& spacepoint_per_hit,
					    const TVector3 &extrapolated_start_position,
					    const TVector3 &extrapolated_direction,
					    vector<TVector3> &running_fit_position_vec,
  ...
  TVector3 CCKaonAnalyzer::getClosestPointToLine3D(const TVector3 &extrapolated_start_position,
						   const TVector3 &extrapolated_direction,
  ...
  bool CCKaonAnalyzer::isCloseToLine(const TVector3 &hit_position,
  ...
  double CCKaonAnalyzer::getClosestDistance(art::Ptr<recob::Hit>& collected_hit,
  ...
  double CCKaonAnalyzer::getClosestDistance(const TVector3 &position,
  ...
  void CCKaonAnalyzer::obtainLength(std::vector<art::Ptr<recob::Hit>>& shower_spine_hit_list,
				    art::FindManyP<recob::SpacePoint>& spacepoint_per_hit,
				    TVector3 Kend_candidate)
  {
  ...
  void CCKaonAnalyzer::obtainLongitudinalDecomposition(std::vector<art::Ptr<recob::Hit>>& shower_spine_hit_list,
						       art::FindManyP<recob::SpacePoint>& spacepoint_per_hit)
  {
  ...
  int CCKaonAnalyzer::fillHistAngularDistributionMapCheat( std::map<int, std::map<int, double>> &angular_distribution_mrgid_map,
							   std::map<int,int> &mrgidpdg,
  ...
  int CCKaonAnalyzer::fillHistAngularDistributionMapCheat3D( std::map<int, std::map<int, std::map<int, double>>> &angular_distribution_mrgid_map_3D,
							     std::map<int,int> &mrgidpdg,
  ...
  int CCKaonAnalyzer::fillHistAngularDistributionMap( std::map<int, double> &angular_distribution_map,
  ...
  int CCKaonAnalyzer::fillHistAngularDistributionMap3D( std::map<int, std::map<int, double>> &angular_distribution_map_3D,
  ...
  int CCKaonAnalyzer::fillHistAngularDistributionMapSurface( std::map<int, std::map<int, double>> &angular_distribution_map_3D,
  ...
  int CCKaonAnalyzer::fillHistAngularDistributionMapSphere( std::map<int, std::map<int, double>> &angular_distribution_map_3D,
  ...
  int CCKaonAnalyzer::drawHistAngularDistributionMapCheat( std::vector<TH1D*> &h_angular_distribution_pfparticle_cheat,
  ...
  int CCKaonAnalyzer::drawHistAngularDistributionMapCheat3D( std::vector<TH2D*> &h_angular_distribution_pfparticle_cheat_3D,
							     std::vector<int> &v_pdg,
							     TString outfile_name,
							     TCanvas* &c){
  ...
  int CCKaonAnalyzer::drawHistAngularDistributionMap( std::vector<TH1D*> &h_angular_distribution_pfparticle,
  ...
  int CCKaonAnalyzer::drawHistAngularDistributionMap3D( std::vector<TH2D*> &h_angular_distribution_pfparticle_3D,
							std::vector<bool> &v_trk_flg,
							TString outfile_name,
							TCanvas* &c){
  ...
  int CCKaonAnalyzer::drawHistAngularDistributionMapSurface( std::vector<TH2D*> &h_angular_distribution_pfparticle_surface,
							     std::vector<bool> &v_trk_flg,
							     TString outfile_name,
							     TCanvas* &c){
  ...
  int CCKaonAnalyzer::drawHistAngularDistributionMapSphere( std::vector<TH3D*> &h_angular_distribution_pfparticle_sphere,
							    std::vector<bool> &v_trk_flg,
							    TString outfile_name,
							    TCanvas* &c){
    TFile outfile(outfile_name, "update");
