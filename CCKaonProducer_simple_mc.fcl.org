...
process_name: CCKaonProducer_simple
...
{	
  producers:
  {
   CCKaonProducer_simple:
   {
      module_type:    "CCKaonProducer_simple"
   }		
  }
...
outputs:
{
 out1:
 {
   ...
   fileName: "CCKaonProducerStream_simple.root"    #default file name, can override from command line with -o or --output
