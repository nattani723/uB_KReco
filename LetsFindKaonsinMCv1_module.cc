...
private:
    ...
    Float_t  k_true_KE;
    Float_t  k_true_theta;
    Float_t  k_reco_chi_p_3plane;
    Float_t  k_reco_chi_k_3plane;
    Float_t  k_reco_chi_pi_3plane;
    Float_t  k_reco_chi_mu_3plane;
    Float_t  mu_reco_chi_p_3plane;
    Float_t  mu_reco_chi_k_3plane;
    Float_t  mu_reco_chi_pi_3plane;
    Float_t  mu_reco_chi_mu_3plane;
...
void LetsFindKaonsinMCv1::beginJob(){
  ...
  fEventTree->Branch("k_true_KE", &k_true_KE,"k_true_KE/F");
  fEventTree->Branch("k_true_theta", &k_true_theta,"k_true_theta/F");
  fEventTree->Branch("k_reco_chi_p_3plane", &k_reco_chi_p_3plane,"k_reco_chi_p_3plane/F");
  fEventTree->Branch("k_reco_chi_k_3plane", &k_reco_chi_k_3plane,"k_reco_chi_k_3plane/F");
  fEventTree->Branch("k_reco_chi_pi_3plane", &k_reco_chi_pi_3plane,"k_reco_chi_pi_3plane/F");
  fEventTree->Branch("k_reco_chi_mu_3plane", &k_reco_chi_mu_3plane,"k_reco_chi_mu_3plane/F");
  fEventTree->Branch("mu_reco_chi_p_3plane", &mu_reco_chi_p_3plane,"mu_reco_chi_p_3plane/F");
  fEventTree->Branch("mu_reco_chi_k_3plane", &mu_reco_chi_k_3plane,"mu_reco_chi_k_3plane/F");
  fEventTree->Branch("mu_reco_chi_pi_3plane", &mu_reco_chi_pi_3plane,"mu_reco_chi_pi_3plane/F");
  fEventTree->Branch("mu_reco_chi_mu_3plane", &mu_reco_chi_mu_3plane,"mu_reco_chi_mu_3plane/F");
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
           ...
           double z = end.Z() - pos.Z();
           double y = end.Y() - pos.Y();

           double theta0 = TMath::ATan2(z,y) - TMath::Pi()/3;
           double theta1 = TMath::ATan2(z,y) + TMath::Pi()/3;
           double theta2 = TMath::ATan2(z,y);

	   double wp0 = TMath::Power(TMath::Sin(theta0),2) >= 0.05 ? 1 : 0;  
	   double wp1 = TMath::Power(TMath::Sin(theta1),2) >= 0.05 ? 1 : 0;  
	   double wp2 = TMath::Power(TMath::Sin(theta2),2) >= 0.05 ? 1 : 0;  

          k_reco_chi_p_3plane = (k_reco_chi_p[0]*wp0 + k_reco_chi_p[1]*wp1 + k_reco_chi_p[2]*wp2)/(wp0 + wp1 + wp2);
          k_reco_chi_k_3plane = (k_reco_chi_k[0]*wp0 + k_reco_chi_k[1]*wp1 + k_reco_chi_k[2]*wp2)/(wp0 + wp1 + wp2);
          k_reco_chi_pi_3plane = (k_reco_chi_pi[0]*wp0 + k_reco_chi_pi[1]*wp1 + k_reco_chi_pi[2]*wp2)/(wp0 + wp1 + wp2);
          k_reco_chi_mu_3plane = (k_reco_chi_mu[0]*wp0 + k_reco_chi_mu[1]*wp1 + k_reco_chi_mu[2]*wp2)/(wp0 + wp1 + wp2);
	...
	/////////////////////////////////////// Accessing decay muon/pion reconstructed information ////////////////////////////// 
	 ...
	 if(mu_can_trkid!=-9999){
	   ...
	   double wp2 = TMath::Power(TMath::Sin(theta2),2) >= 0.05 ? 1 : 0;  
          ...
          mu_reco_chi_p_3plane = (mu_reco_chi_p[0]*wp0 + mu_reco_chi_p[1]*wp1 + mu_reco_chi_p[2]*wp2)/(wp0 + wp1 + wp2);
          mu_reco_chi_k_3plane = (mu_reco_chi_k[0]*wp0 + mu_reco_chi_k[1]*wp1 + mu_reco_chi_k[2]*wp2)/(wp0 + wp1 + wp2);
          mu_reco_chi_pi_3plane = (mu_reco_chi_pi[0]*wp0 + mu_reco_chi_pi[1]*wp1 + mu_reco_chi_pi[2]*wp2)/(wp0 + wp1 + wp2);
          mu_reco_chi_mu_3plane = (mu_reco_chi_mu[0]*wp0 + mu_reco_chi_mu[1]*wp1 + mu_reco_chi_mu[2]*wp2)/(wp0 + wp1 + wp2);
		 ...
		 if(origin==1){
		    ...
		    if((stx>0 && stx<256.35) && (sty>-116.5 && sty<116.5) && (stz>0 && stz<1036.8)){
		        true_k_ext=1;
                        ...
                        k_true_theta=pPart->Momentum().Theta()*57.3;
                        //k_endE=pPart->EndE()*1000;
                        //k_stE=pPart->E()*1000;
                        k_true_KE=(pPart->E()-pPart->Mass())*1000; //MeV
...
void LetsFindKaonsinMCv1::reset(){
     ...
     k_true_KE=-9999;
     k_true_theta=-9999;
     k_reco_chi_p_3plane=-9999;
     k_reco_chi_k_3plane=-9999;
     k_reco_chi_pi_3plane=-9999;
     k_reco_chi_mu_3plane=-9999;

     mu_reco_chi_p_3plane=-9999;
     mu_reco_chi_k_3plane=-9999;
     mu_reco_chi_pi_3plane=-9999;
     mu_reco_chi_mu_3plane=-9999;
